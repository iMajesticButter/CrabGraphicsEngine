...
namespace CrabEngine {
    namespace Graphics {
        ...
        GraphicsObject2D::GraphicsObject2D() : location(0,0,0), scale(1,1), rotation(0), visible(true), castShadows(false), m_material(nullptr), m_mesh(nullptr) {

        }
        GraphicsObject2D::GraphicsObject2D(Mesh* mesh, Material* mat) : location(0,0,0), scale(1,1), rotation(0), visible(true), castShadows(false), m_material(mat), m_mesh(mesh) {
